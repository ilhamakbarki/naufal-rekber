                                    ...
                                    <div class="card-body">
                        			    <div class="table-responsive">
                        			        <table class="table table-bordered">
                        			            ...
                        			            <?php if ($target->order_by == 'Penjual') { ?>
                        			            
                        			            <tr>
                        			                <th>Total Yang Didapatkan</th>
                        			                <td>Rp <?= number_format($get_amount,0,',','.') ?></td>
                        			            </tr>
                        			            <?php } else if ($target->order_by == 'Pembeli') { ?>
                        			            ...
                        			            <tr>
                        			                <td align="center" colspan="2">
                        			                    <div class="row">
                        			                        ...
                        			                        <div class="col-md-4">
                        			                            <a href="<?= base_url() ?>order/chat/<?= $target->order_id ?>" class="btn btn-outline-primary btn-block rounded-pill<?= ($target->status == 'Canceled') ? ' disabled' : '' ?>"><i class="las la-comment fs-18"></i></a>
                        			                        </div>
                        			                    </div>
                        			                </td>
                        			            </tr>
                        ...
                        <?php if ($target->order_by == 'Pembeli') { ?>
                        <!-- Modal -->
